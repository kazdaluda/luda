...
<head>
    ...
    <meta name="interkassa-verification" content="2fd49659527014b4dc875676827fc973" />
    ...
    <div class="container">
        ...
        <div id="top-links" class="nav pull-right">
            <ul class="list-inline">
                <li><a href="/inform"><i class="fa fa-phone"></i></a>
                ...
                <li class="dropdown"><a href="/index.php?route=account/account" title="My Account"
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <?php if (Yii::$app->user->isGuest): ?>
                            ...
                            <li><a href="<?= Html::encode(Url::to(['/auth/signup'])) ?>">Signup</a></li>
                        <?php else: ?>
                            ...
                            <li><a href="<?= Html::encode(Url::to(['/backend/web'])) ?>" data-method="post">admin</a></li>
                        <?php endif; ?>
                    </ul>
                </li>
...
<div class="container">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            //['label' => 'vova', 'url' => ['/vova/vova/luda']],
           // ['label' => 'vova', 'url' => ['/market/index']],
        ],
    ]);
    NavBar::end();
    ?>
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="/myasnye-kanape">Terms
                            &amp; Conditions</a></li>
                </ul>
            </div>
            <div class="col-sm-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="/dely">dely</a></li>
                    <li><a href="/return">return Map</a></li>
                </ul>
            </div>
            <div class="col-sm-3">
                <h5>Extras</h5>
